...
The app generates a nested spoke infrastructure manifest (schema v1.1.0). See [`output.md`](./output.md) for the full spec and [`schema-template-v1.1.0.md`](./schema-template-v1.1.0.md) for the annotated reference template.
