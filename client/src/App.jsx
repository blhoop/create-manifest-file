...
import schemaContent from '../../schema-template-v1.7.0.yml?raw'
import './App.css'
    ...
    <div className="app">
      <header className="app-header">
        ...
        <div className="app-header-links">
          ...
          <button className="doc-link-btn" onClick={() => setDocModal({ title: 'schema-template-v1.7.0.yml', content: schemaContent })}>Schema Template</button>
        </div>
      </header>
