```yaml
# =============================================================================
# Spoke Infrastructure Manifest — Schema Template
# =============================================================================
#
...
compute:
  ...
  # --- App Service Plans ---
  # Shared plans that web apps and function apps are assigned to.
  app_service_plans:
    - id: asp_web                       # REQUIRED — unique ID, referenced by web_apps/function_apps via asp_id
      subsystem: compute                # REQUIRED — naming segment (e.g. "compute", "functions", "webjobs")
      module: terraform-azurerm-app-service-plan  # REQUIRED — CTM module registry name
      os_type: Windows                  # REQUIRED — Windows or Linux
      sku: P1v3                         # REQUIRED — SKU name. Minimum tiers by type:
                                        #   Web apps: P1v3 (Premium required for VNet integration, slots)
                                        #   Function apps: EP1 (Elastic Premium required for VNet integration)
  ...
  web_apps:
    - id: web_api                       # REQUIRED — unique ID
      ...
      asp_id: asp_web                   # REQUIRED — must match an app_service_plans id
  ...
  function_apps:
    - id: func_booking-expiry           # REQUIRED — unique ID
      ...
      asp_id: asp_func                  # REQUIRED — must match an app_service_plans id
...
data:
  ...
  #     sku: Balanced_B0                # Minimum: Balanced_B0 (supports private endpoints). Never Basic.
